...
class FormHairbows extends Component {
  constructor() {
    super();
    this.state = {
      name: "",
  ...
  render() {
    return (
      <div className="form-component-container">
        <div className="form-title">Add hairbows to store inventory</div>
        <Form>
          <Image
          ...
          <div className="form-category-name">
            ...
            >
              ...
              <option>Hairbows Main Page</option>
