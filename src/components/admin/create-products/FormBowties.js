...
class FormBowties extends Component {
  constructor() {
    super();
    this.state = {
      name: "",
  ...
  render() {
    return (
      <div className="form-component-container">
        <div className="form-title">Add bowties to store inventory</div>
        <Form>
          <Image
          ...
          <div className="form-category-name">
            ...
            >
              ...
              <option>Bowties Main Page</option>
