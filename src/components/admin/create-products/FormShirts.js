...
class FormShirts extends Component {
  constructor() {
    super();
    this.state = {
      name: "",
  ...
  render() {
    return (
      <div className="form-component-container">
        <div className="form-title">Add a shirts to store inventory</div>
        <Form>
          <Image
          ...
          <div className="form-category-name">
            ...
            >
              ...
              <option>Shirts Main Page</option>
