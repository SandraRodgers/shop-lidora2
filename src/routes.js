...
export default(
    ...
    <Switch>
        ...
        <Route path="/shop/bowties" exact component={Bowties} /> <Route path="/shop/hairbows" exact component={Hairbows} /> <Route path="/shop/headbands" exact component={Headbands} /> <Route path="/shop/suspenders" exact component={Suspenders} /> 
      <Route path="/shop/bibdanas" exact component={Bibdanas} /> <Route path="/shop/burpcloths" exact component={BurpClothes} />
